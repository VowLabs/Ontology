...
Canonical code: `G:CO:TC`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Turks and Caicos Islands** and its official name is **Turks and Caicos Islands**.
Its two-letter key is `TC` and its three-letter code is `TCA`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:TC` for a country relationship, for example as a Country choice in an
...
Source: [data/country/TC.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/TC.json),
