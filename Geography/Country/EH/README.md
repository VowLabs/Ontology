...
Canonical code: `G:CO:EH`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Western Sahara** and its official name is **Sahrawi Arab Democratic Republic**.
Its two-letter key is `EH` and its three-letter code is `ESH`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:EH` for a country relationship, for example as a Country choice in an
...
Source: [data/country/EH.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/EH.json),
