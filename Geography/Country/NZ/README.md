...
Canonical code: `G:CO:NZ`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **New Zealand** and its official name is **New Zealand**.
Its two-letter key is `NZ` and its three-letter code is `NZL`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:NZ` for a country relationship, for example as a Country choice in an
...
Source: [data/country/NZ.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/NZ.json),
