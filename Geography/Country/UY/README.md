...
Canonical code: `G:CO:UY`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Uruguay** and its official name is **Oriental Republic of Uruguay**.
Its two-letter key is `UY` and its three-letter code is `URY`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:UY` for a country relationship, for example as a Country choice in an
...
Source: [data/country/UY.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/UY.json),
