...
Canonical code: `G:CO:CI`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Ivory Coast** and its official name is **Republic of Côte d'Ivoire**.
Its two-letter key is `CI` and its three-letter code is `CIV`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:CI` for a country relationship, for example as a Country choice in an
...
Source: [data/country/CI.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/CI.json),
