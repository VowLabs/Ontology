...
Canonical code: `G:CO:AS`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **American Samoa** and its official name is **American Samoa**.
Its two-letter key is `AS` and its three-letter code is `ASM`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:AS` for a country relationship, for example as a Country choice in an
...
Source: [data/country/AS.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/AS.json),
