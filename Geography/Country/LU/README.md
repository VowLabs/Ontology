...
Canonical code: `G:CO:LU`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Luxembourg** and its official name is **Grand Duchy of Luxembourg**.
Its two-letter key is `LU` and its three-letter code is `LUX`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:LU` for a country relationship, for example as a Country choice in an
...
Source: [data/country/LU.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/LU.json),
