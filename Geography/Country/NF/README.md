...
Canonical code: `G:CO:NF`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Norfolk Island** and its official name is **Territory of Norfolk Island**.
Its two-letter key is `NF` and its three-letter code is `NFK`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:NF` for a country relationship, for example as a Country choice in an
...
Source: [data/country/NF.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/NF.json),
