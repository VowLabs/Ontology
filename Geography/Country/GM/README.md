...
Canonical code: `G:CO:GM`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Gambia** and its official name is **Republic of the Gambia**.
Its two-letter key is `GM` and its three-letter code is `GMB`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:GM` for a country relationship, for example as a Country choice in an
...
Source: [data/country/GM.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/GM.json),
