...
Canonical code: `G:CO:SZ`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Eswatini** and its official name is **Kingdom of Eswatini**.
Its two-letter key is `SZ` and its three-letter code is `SWZ`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:SZ` for a country relationship, for example as a Country choice in an
...
Source: [data/country/SZ.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/SZ.json),
