...
Canonical code: `G:CO:US`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **United States** and its official name is **United States of America**.
Its two-letter key is `US` and its three-letter code is `USA`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:US` for a country relationship, for example as a Country choice in an
...
Source: [data/country/US.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/US.json),
