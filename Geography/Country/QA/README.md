...
Canonical code: `G:CO:QA`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Qatar** and its official name is **State of Qatar**.
Its two-letter key is `QA` and its three-letter code is `QAT`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:QA` for a country relationship, for example as a Country choice in an
...
Source: [data/country/QA.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/QA.json),
