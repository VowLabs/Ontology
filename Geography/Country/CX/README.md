...
Canonical code: `G:CO:CX`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Christmas Island** and its official name is **Territory of Christmas Island**.
Its two-letter key is `CX` and its three-letter code is `CXR`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:CX` for a country relationship, for example as a Country choice in an
...
Source: [data/country/CX.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/CX.json),
