...
Canonical code: `G:CO:SA`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Saudi Arabia** and its official name is **Kingdom of Saudi Arabia**.
Its two-letter key is `SA` and its three-letter code is `SAU`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:SA` for a country relationship, for example as a Country choice in an
...
Source: [data/country/SA.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/SA.json),
