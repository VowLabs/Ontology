...
Canonical code: `G:CO:GP`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Guadeloupe** and its official name is **Guadeloupe**.
Its two-letter key is `GP` and its three-letter code is `GLP`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:GP` for a country relationship, for example as a Country choice in an
...
Source: [data/country/GP.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/GP.json),
