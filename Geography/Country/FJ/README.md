...
Canonical code: `G:CO:FJ`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Fiji** and its official name is **Republic of Fiji**.
Its two-letter key is `FJ` and its three-letter code is `FJI`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:FJ` for a country relationship, for example as a Country choice in an
...
Source: [data/country/FJ.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/FJ.json),
