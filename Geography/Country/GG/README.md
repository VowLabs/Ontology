...
Canonical code: `G:CO:GG`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Guernsey** and its official name is **Bailiwick of Guernsey**.
Its two-letter key is `GG` and its three-letter code is `GGY`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:GG` for a country relationship, for example as a Country choice in an
...
Source: [data/country/GG.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/GG.json),
