...
Canonical code: `G:CO:BD`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Bangladesh** and its official name is **People's Republic of Bangladesh**.
Its two-letter key is `BD` and its three-letter code is `BGD`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:BD` for a country relationship, for example as a Country choice in an
...
Source: [data/country/BD.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/BD.json),
