...
Canonical code: `G:CO:DO`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Dominican Republic** and its official name is **Dominican Republic**.
Its two-letter key is `DO` and its three-letter code is `DOM`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:DO` for a country relationship, for example as a Country choice in an
...
Source: [data/country/DO.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/DO.json),
