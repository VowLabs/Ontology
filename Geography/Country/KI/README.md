...
Canonical code: `G:CO:KI`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Kiribati** and its official name is **Independent and Sovereign Republic of Kiribati**.
Its two-letter key is `KI` and its three-letter code is `KIR`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:KI` for a country relationship, for example as a Country choice in an
...
Source: [data/country/KI.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/KI.json),
