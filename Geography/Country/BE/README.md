...
Canonical code: `G:CO:BE`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Belgium** and its official name is **Kingdom of Belgium**.
Its two-letter key is `BE` and its three-letter code is `BEL`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:BE` for a country relationship, for example as a Country choice in an
...
Source: [data/country/BE.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/BE.json),
