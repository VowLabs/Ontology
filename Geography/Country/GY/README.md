...
Canonical code: `G:CO:GY`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Guyana** and its official name is **Co-operative Republic of Guyana**.
Its two-letter key is `GY` and its three-letter code is `GUY`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:GY` for a country relationship, for example as a Country choice in an
...
Source: [data/country/GY.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/GY.json),
