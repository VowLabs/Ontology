...
Canonical code: `G:CO:DK`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Denmark** and its official name is **Kingdom of Denmark**.
Its two-letter key is `DK` and its three-letter code is `DNK`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:DK` for a country relationship, for example as a Country choice in an
...
Source: [data/country/DK.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/DK.json),
