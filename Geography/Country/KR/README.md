...
Canonical code: `G:CO:KR`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **South Korea** and its official name is **Republic of Korea**.
Its two-letter key is `KR` and its three-letter code is `KOR`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:KR` for a country relationship, for example as a Country choice in an
...
Source: [data/country/KR.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/KR.json),
