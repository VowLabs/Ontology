...
Canonical code: `G:CO:ZM`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Zambia** and its official name is **Republic of Zambia**.
Its two-letter key is `ZM` and its three-letter code is `ZMB`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:ZM` for a country relationship, for example as a Country choice in an
...
Source: [data/country/ZM.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/ZM.json),
