...
Canonical code: `G:CO:TN`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Tunisia** and its official name is **Tunisian Republic**.
Its two-letter key is `TN` and its three-letter code is `TUN`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:TN` for a country relationship, for example as a Country choice in an
...
Source: [data/country/TN.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/TN.json),
