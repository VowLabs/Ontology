...
Canonical code: `G:CO:AG`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Antigua and Barbuda** and its official name is **Antigua and Barbuda**.
Its two-letter key is `AG` and its three-letter code is `ATG`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:AG` for a country relationship, for example as a Country choice in an
...
Source: [data/country/AG.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/AG.json),
