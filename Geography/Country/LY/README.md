...
Canonical code: `G:CO:LY`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Libya** and its official name is **State of Libya**.
Its two-letter key is `LY` and its three-letter code is `LBY`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:LY` for a country relationship, for example as a Country choice in an
...
Source: [data/country/LY.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/LY.json),
