...
Canonical code: `G:CO:BQ`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Caribbean Netherlands** and its official name is **Bonaire, Sint Eustatius and Saba**.
Its two-letter key is `BQ` and its three-letter code is `BES`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:BQ` for a country relationship, for example as a Country choice in an
...
Source: [data/country/BQ.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/BQ.json),
