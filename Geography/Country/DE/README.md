...
Canonical code: `G:CO:DE`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Germany** and its official name is **Federal Republic of Germany**.
Its two-letter key is `DE` and its three-letter code is `DEU`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:DE` for a country relationship, for example as a Country choice in an
...
Source: [data/country/DE.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/DE.json),
