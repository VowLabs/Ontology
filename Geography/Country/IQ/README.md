...
Canonical code: `G:CO:IQ`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Iraq** and its official name is **Republic of Iraq**.
Its two-letter key is `IQ` and its three-letter code is `IRQ`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:IQ` for a country relationship, for example as a Country choice in an
...
Source: [data/country/IQ.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/IQ.json),
