...
Canonical code: `G:CO:BS`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Bahamas** and its official name is **Commonwealth of the Bahamas**.
Its two-letter key is `BS` and its three-letter code is `BHS`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:BS` for a country relationship, for example as a Country choice in an
...
Source: [data/country/BS.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/BS.json),
