...
Canonical code: `G:CO:PF`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **French Polynesia** and its official name is **French Polynesia**.
Its two-letter key is `PF` and its three-letter code is `PYF`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:PF` for a country relationship, for example as a Country choice in an
...
Source: [data/country/PF.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/PF.json),
