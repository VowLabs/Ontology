...
Canonical code: `G:CO:PK`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Pakistan** and its official name is **Islamic Republic of Pakistan**.
Its two-letter key is `PK` and its three-letter code is `PAK`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:PK` for a country relationship, for example as a Country choice in an
...
Source: [data/country/PK.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/PK.json),
