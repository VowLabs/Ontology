...
Canonical code: `G:CO:NG`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Nigeria** and its official name is **Federal Republic of Nigeria**.
Its two-letter key is `NG` and its three-letter code is `NGA`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:NG` for a country relationship, for example as a Country choice in an
...
Source: [data/country/NG.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/NG.json),
