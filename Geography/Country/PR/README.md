...
Canonical code: `G:CO:PR`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Puerto Rico** and its official name is **Commonwealth of Puerto Rico**.
Its two-letter key is `PR` and its three-letter code is `PRI`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:PR` for a country relationship, for example as a Country choice in an
...
Source: [data/country/PR.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/PR.json),
