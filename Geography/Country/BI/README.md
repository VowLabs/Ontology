...
Canonical code: `G:CO:BI`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Burundi** and its official name is **Republic of Burundi**.
Its two-letter key is `BI` and its three-letter code is `BDI`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:BI` for a country relationship, for example as a Country choice in an
...
Source: [data/country/BI.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/BI.json),
