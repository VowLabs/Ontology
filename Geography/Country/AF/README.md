...
Canonical code: `G:CO:AF`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Afghanistan** and its official name is **Islamic Republic of Afghanistan**.
Its two-letter key is `AF` and its three-letter code is `AFG`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:AF` for a country relationship, for example as a Country choice in an
...
Source: [data/country/AF.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/AF.json),
