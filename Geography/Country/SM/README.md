...
Canonical code: `G:CO:SM`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **San Marino** and its official name is **Republic of San Marino**.
Its two-letter key is `SM` and its three-letter code is `SMR`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:SM` for a country relationship, for example as a Country choice in an
...
Source: [data/country/SM.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/SM.json),
