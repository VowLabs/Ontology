...
Canonical code: `G:CO:CV`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Cape Verde** and its official name is **Republic of Cabo Verde**.
Its two-letter key is `CV` and its three-letter code is `CPV`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:CV` for a country relationship, for example as a Country choice in an
...
Source: [data/country/CV.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/CV.json),
