...
Canonical code: `G:CO:CW`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Curaçao** and its official name is **Country of Curaçao**.
Its two-letter key is `CW` and its three-letter code is `CUW`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:CW` for a country relationship, for example as a Country choice in an
...
Source: [data/country/CW.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/CW.json),
