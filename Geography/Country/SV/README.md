...
Canonical code: `G:CO:SV`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **El Salvador** and its official name is **Republic of El Salvador**.
Its two-letter key is `SV` and its three-letter code is `SLV`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:SV` for a country relationship, for example as a Country choice in an
...
Source: [data/country/SV.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/SV.json),
