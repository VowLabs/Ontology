...
Canonical code: `G:CO:VG`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **British Virgin Islands** and its official name is **Virgin Islands**.
Its two-letter key is `VG` and its three-letter code is `VGB`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:VG` for a country relationship, for example as a Country choice in an
...
Source: [data/country/VG.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/VG.json),
