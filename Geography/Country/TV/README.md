...
Canonical code: `G:CO:TV`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Tuvalu** and its official name is **Tuvalu**.
Its two-letter key is `TV` and its three-letter code is `TUV`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:TV` for a country relationship, for example as a Country choice in an
...
Source: [data/country/TV.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/TV.json),
