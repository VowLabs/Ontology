...
Canonical code: `G:CO:IR`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Iran** and its official name is **Islamic Republic of Iran**.
Its two-letter key is `IR` and its three-letter code is `IRN`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:IR` for a country relationship, for example as a Country choice in an
...
Source: [data/country/IR.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/IR.json),
