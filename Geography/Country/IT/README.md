...
Canonical code: `G:CO:IT`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Italy** and its official name is **Italian Republic**.
Its two-letter key is `IT` and its three-letter code is `ITA`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:IT` for a country relationship, for example as a Country choice in an
...
Source: [data/country/IT.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/IT.json),
