...
Canonical code: `G:CO:LT`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Lithuania** and its official name is **Republic of Lithuania**.
Its two-letter key is `LT` and its three-letter code is `LTU`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:LT` for a country relationship, for example as a Country choice in an
...
Source: [data/country/LT.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/LT.json),
