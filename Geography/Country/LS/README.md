...
Canonical code: `G:CO:LS`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Lesotho** and its official name is **Kingdom of Lesotho**.
Its two-letter key is `LS` and its three-letter code is `LSO`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:LS` for a country relationship, for example as a Country choice in an
...
Source: [data/country/LS.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/LS.json),
