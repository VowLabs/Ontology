...
Canonical code: `G:CO:LK`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Sri Lanka** and its official name is **Democratic Socialist Republic of Sri Lanka**.
Its two-letter key is `LK` and its three-letter code is `LKA`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:LK` for a country relationship, for example as a Country choice in an
...
Source: [data/country/LK.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/LK.json),
