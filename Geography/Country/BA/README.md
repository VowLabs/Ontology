...
Canonical code: `G:CO:BA`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Bosnia and Herzegovina** and its official name is **Bosnia and Herzegovina**.
Its two-letter key is `BA` and its three-letter code is `BIH`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:BA` for a country relationship, for example as a Country choice in an
...
Source: [data/country/BA.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/BA.json),
