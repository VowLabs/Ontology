...
Canonical code: `G:CO:UZ`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Uzbekistan** and its official name is **Republic of Uzbekistan**.
Its two-letter key is `UZ` and its three-letter code is `UZB`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:UZ` for a country relationship, for example as a Country choice in an
...
Source: [data/country/UZ.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/UZ.json),
