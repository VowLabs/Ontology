...
Canonical code: `G:CO:AR`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Argentina** and its official name is **Argentine Republic**.
Its two-letter key is `AR` and its three-letter code is `ARG`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:AR` for a country relationship, for example as a Country choice in an
...
Source: [data/country/AR.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/AR.json),
