...
Canonical code: `G:CO:MG`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Madagascar** and its official name is **Republic of Madagascar**.
Its two-letter key is `MG` and its three-letter code is `MDG`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:MG` for a country relationship, for example as a Country choice in an
...
Source: [data/country/MG.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/MG.json),
