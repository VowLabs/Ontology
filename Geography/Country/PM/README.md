...
Canonical code: `G:CO:PM`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Saint Pierre and Miquelon** and its official name is **Saint Pierre and Miquelon**.
Its two-letter key is `PM` and its three-letter code is `SPM`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:PM` for a country relationship, for example as a Country choice in an
...
Source: [data/country/PM.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/PM.json),
