...
Canonical code: `G:CO:ET`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Ethiopia** and its official name is **Federal Democratic Republic of Ethiopia**.
Its two-letter key is `ET` and its three-letter code is `ETH`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:ET` for a country relationship, for example as a Country choice in an
...
Source: [data/country/ET.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/ET.json),
