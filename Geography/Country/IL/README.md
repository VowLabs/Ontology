...
Canonical code: `G:CO:IL`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Israel** and its official name is **State of Israel**.
Its two-letter key is `IL` and its three-letter code is `ISR`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:IL` for a country relationship, for example as a Country choice in an
...
Source: [data/country/IL.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/IL.json),
