...
Canonical code: `G:CO:TL`. [Definition](index.json).

This is a country or territory entry from the pinned `ekkis/geo` dataset. The
source’s common name is **Timor-Leste** and its official name is **Democratic Republic of Timor-Leste**.
Its two-letter key is `TL` and its three-letter code is `TLS`.
These identifiers follow the source vocabulary; inclusion does not assert
sovereignty or resolve jurisdictional disputes.

Use `G:CO:TL` for a country relationship, for example as a Country choice in an
...
Source: [data/country/TL.json](https://github.com/ekkis/geo/blob/f7e2f4aa4f8333c7d09682f0b323673225e02011/data/country/TL.json),
