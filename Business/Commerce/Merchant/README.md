...
Canonical code: `B:C:M`. Definition: [index.json](index.json).
...
### Business name — `B:C:M:N`

The field answers: “What is the business name?”

Value type: [String (`S:I:D:T:S`)](../../../Science/Information/Data/Types/String.json); stored as `string`.

Maximum length: `2000`.

SourceKey: `businessName`.

[Field definition](BusinessName.json).

### Wallet address — `B:C:M:W`
...
[Field definition](WalletAddress.json).

### Website — `B:C:M:U`

The field answers: “What is the website?”
